...
BOOL CGPSProc::StartPubNetSystem()
{
	...
	if (m_iocpsocket.OnStartIOCPSocket(m_dwMaxConnect,m_dwAcceptTime,m_dwIdleOverTime,m_dwHeartBeatTime,m_dwTimeAutoConnect,m_dwIODataCount,m_dwIODataBuffer,m_nSocketBuffer))
	{
		m_IsIOCPActive = TRUE;
	}
